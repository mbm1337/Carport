...
public class MailSenderController {
    ...
    public static void sendDetailsToCustomer(Carport carport, String emailRecipient, String userName, int userPhoneNumber, String userEmail) {
        // Provide recipient's email ID
        ...
        try {
            ...
            // Construct the email body
            String emailBody = sendOrderToCustomer(carport, userName, userPhoneNumber, userEmail);
            // Set the content of the email message
            message.setText(emailBody);
            // Send the email message
            Transport.send(message);
    ...
    private static String sendOrderToCustomer(Carport carport, String userName, int userPhoneNumber, String userEmail) {
